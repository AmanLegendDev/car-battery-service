...
interface TestimonialsListingCTAProps {
  businessName: string;
  phone: string;
}

export default function TestimonialsListingCTA({
  businessName,
  phone,
}: TestimonialsListingCTAProps) {
        ...
        <div className="grid items-end gap-10 lg:grid-cols-[1fr_auto] lg:gap-16">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-2xl text-sm leading-7 text-white/50 sm:text-base sm:leading-8">
              ...
              assistance, including battery replacement,
              battery testing and jump start assistance.
            </p>
          </div>

  ...
  return (
    <section className="relative overflow-hidden bg-[#F8FAFC]">
      ...
      <div className="relative mx-auto max-w-4xl px-5 py-20 sm:px-8 sm:py-24 lg:px-10 lg:py-28">
        <div className="rounded-[2rem] border border-[#061A2B]/[0.08] bg-white px-6 py-12 text-center shadow-[0_15px_50px_rgba(6,26,43,0.04)] sm:px-10 sm:py-16">
          {/* Icon */}
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-[#061A2B]/45 sm:text-base">
            {businessName} has not published customer
            feedback here yet. In the meantime, explore

...
import { CONTACT_HERO } from "./contactHeroData";
...
export default function ContactHero({
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[#061A2B]">
      ...
      >
        <div className="absolute -left-40 top-[-8rem] h-[28rem] w-[28rem] rounded-full bg-[#0D6E91]/20 blur-[100px]" />

        <div className="absolute -right-40 bottom-[-10rem] h-[32rem] w-[32rem] rounded-full bg-[#FFD400]/10 blur-[120px]" />

        <div className="absolute right-[25%] top-[15%] h-40 w-40 rounded-full bg-[#0D6E91]/10 blur-[80px]" />
        ...
        <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#061A2B] to-transparent" />
      </div>
        ...
        <div className="grid items-center gap-14 lg:grid-cols-[1.08fr_0.92fr] lg:gap-20">
          ...
          <div className="max-w-3xl mt-8">
            ...
            <h1 className="mt-7 max-w-3xl text-4xl font-semibold leading-[1.05] tracking-[-0.045em] text-[#F8FAFC] sm:text-5xl md:text-6xl lg:text-[4.5rem]">
              ...
              <span className="relative inline-block text-[#FFD400]">
                ...
                <span
                  aria-hidden="true"
                  className="absolute -bottom-1 left-0 h-px w-full bg-[#FFD400]/50"
                />
              </span>
            </h1>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              {phoneHref ? (
                ...
                >
                  ...
                  {CONTACT_HERO.secondaryCta}
                </a>
              ) : null}
            </div>

            <div className="mt-9 flex flex-wrap gap-x-6 gap-y-3">
              <div className="flex items-center gap-2 text-xs font-medium text-[#A8BBC8]">
                <CheckCircle2
                  size={15}
                  className="text-[#FFD400]"
                />
          ...
          <div className="relative lg:justify-self-end lg:w-full lg:max-w-[30rem]">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.055] p-6 shadow-2xl backdrop-blur-xl sm:p-8">
              <div className="absolute right-0 top-0 h-32 w-32 rounded-full bg-[#FFD400]/[0.07] blur-3xl" />

              <div className="relative">
                <div className="flex items-start justify-between gap-5">
                  <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#FFD400] text-[#061A2B] shadow-lg">
                  ...
                  {phone ? (
                    ...
                    >
                      ...
                      <span className="min-w-0">
                        <span className="block text-[10px] font-bold uppercase tracking-[0.15em] text-[#A8BBC8]">
                          Call
                        </span>

                        <span className="mt-1 block truncate text-sm font-semibold text-[#F8FAFC]">
                          {phone}
                        </span>
                      </span>
                ...
                <div className="mt-7 border-t border-white/10 pt-5">
                  <p className="text-xs leading-6 text-[#A8BBC8]">
                    For a complete service request, use the
                    dedicated booking page.
                  </p>

                  <Link
                    href="/book-service"
                    className="mt-4 inline-flex items-center gap-2 text-sm font-bold text-[#FFD400] transition hover:text-[#F5B800]"
                  >
                    Go to booking
                    <ArrowRight size={15} />
                  </Link>
